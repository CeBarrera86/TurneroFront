...
export const router = createBrowserRouter([
  {
    ...
    children: [
      { path: '', element: <Home /> },
      { path: '/turnero/secciones/cajas', element: (<AdminRoute><SeccionesCajas /></AdminRoute>) },
      { path: '/turnero/secciones/usuarios', element: (<AdminRoute><SeccionesUsuarios /></AdminRoute>) },
      { path: '/turnero/secciones/reclamos', element: (<AdminRoute><SeccionesReclamos /></AdminRoute>) },
      { path: '/turnero/estados', element: (<AdminRoute><Estados /></AdminRoute>) },
      { path: '/turnero/estados/crear', element: (<AdminRoute><CrearEstado /></AdminRoute>) },
      { path: '/turnero/estados/editar/:id', element: (<AdminRoute><EditarEstado /></AdminRoute>) },
      { path: '/turnero/mostradores', element: (<AdminRoute><Mostradores /></AdminRoute>) },
      { path: '/turnero/mostradores/crear', element: (<AdminRoute><CrearMostrador /></AdminRoute>) },
      { path: '/turnero/mostradores/editar/:id', element: (<AdminRoute><EditarMostrador /></AdminRoute>) },
      { path: '/turnero/difusiones', element: (<AdminRoute><Contenidos /></AdminRoute>) },
      { path: '/turnero/difusiones/crear', element: (<AdminRoute><CrearContenido /></AdminRoute>) },
      { path: '/turnero/roles', element: (<AdminRoute><Roles /></AdminRoute>) },
      { path: '/turnero/roles/crear', element: (<AdminRoute><CrearRol /></AdminRoute>) },
      { path: '/turnero/roles/editar/:id', element: (<AdminRoute><EditarRol /></AdminRoute>) },
      { path: '/turnero/sectores', element: (<AdminRoute><Sectores /></AdminRoute>) },
      { path: '/turnero/sectores/crear', element: (<AdminRoute><CrearSector /></AdminRoute>) },
      { path: '/turnero/sectores/editar/:id', element: (<AdminRoute><EditarSector /></AdminRoute>) },
      { path: '/turnero/usuarios', element: (<AdminRoute><Usuarios /></AdminRoute>) },
      { path: '/turnero/usuarios/crear', element: (<AdminRoute><CrearUsuario /></AdminRoute>) },
      { path: '/turnero/usuarios/editar/:id', element: (<AdminRoute><EditarUsuario /></AdminRoute>) },
    ],
  },
