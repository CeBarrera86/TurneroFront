...
import { getRoles, getUsuarioPorId, updateUsuario } from '@/features/usuarios/controllers/usuariosController';
  ...
  return (
    <Box sx={{ maxWidth: 500, mx: 'auto' }}>
      <EditarForm
        ...
        onSubmit={(usuarioId, payload, token) => updateUsuario(usuarioId, payload as any, token ?? '')}
